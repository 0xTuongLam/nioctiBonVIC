...
export default function Home() {
  ...
  const handleMax = () => {
    if (userBalance) {
      const maxAmount = Math.max(0, Number.parseFloat(formatEther(userBalance.value)) - 0.01)
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-[#f6f6f8] dark:bg-[#121117]">
                  ...
                  <div className="border-t border-b border-white/10 py-6">
                    ...
                    <div className="w-full mt-4">
                      ...
                      <div className="w-full bg-[#2a2938] rounded-full h-3">
                        <div
                          className="bg-[#5048e5] h-3 rounded-full transition-all"
                ...
                <div className="pt-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <input
                        className="w-full bg-[#2a2938] text-white border border-[#3e3d52] rounded-lg h-12 px-4"
                        disabled
                        id="receive-amount"
                        placeholder="0"
                        type="text"
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row gap-4">
                    <button
                      ...
                      className="flex-1 flex min-w-[84px] max-w-full cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-4 bg-[#5048e5] text-white text-base font-bold leading-normal tracking-[0.015em] disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#5048e5]/90 transition-colors"
                    >
                      <span className="truncate">Buy Now</span>
                    </button>
                    <button
                      onClick={handleClaim}
                      disabled={!isConnected || !claimable || Number(claimable) === 0}
                      className="flex-1 flex min-w-[84px] max-w-full items-center justify-center overflow-hidden rounded-xl h-12 px-4 bg-[#2a2938] text-white text-base font-bold leading-normal tracking-[0.015em] disabled:opacity-50 disabled:cursor-not-allowed enabled:hover:bg-[#3a3948] enabled:cursor-pointer transition-colors"
                    >
                  ...
                  <div className="mt-8 p-4 bg-[#2a2938] rounded-lg border border-[#3e3d52] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                      ...
                      <p className="text-lg font-bold text-white">
                        {userBalance ? Number.parseFloat(formatEther(userBalance.value)).toFixed(4) : "0"} VIC
                      </p>
                    </div>
